const App = {
    setup() {
            ...
            create: async (dataSource) => {
                mainGrid.obj = new ej.grids.Grid({
                    ...
                    columns: [
                        ...
                        { field: 'name', headerText: 'Tên thuế', width: 200, minWidth: 200 },
                        {
                            field: 'percentage',
                            headerText: 'Tỷ lệ (%)',
                            width: 100,
        ...
        const validateForm = function () {
            ...
            if (!state.name) {
                state.errors.name = 'Tên thuế không được để trống.';
                isValid = false;
            }
            if (!state.percentage || isNaN(parseFloat(state.percentage))) {
                state.errors.percentage = 'Tỷ lệ phần trăm là bắt buộc và phải là số.';
                isValid = false;
            } else if (parseFloat(state.percentage) < 0 || parseFloat(state.percentage) > 100) {
                state.errors.percentage = 'Tỷ lệ phần trăm phải từ 0 đến 100.';
                isValid = false;
            }
