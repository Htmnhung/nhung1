const App = {
    setup() {
        ...
        const validateForm = function () {
            ...
            if (!state.orderDate) {
                state.errors.orderDate = 'Ngày bán không được để trống.';
                isValid = false;
            }
            if (!state.customerId) {
                state.errors.customerId = 'Khách hàng không được để trống.';
                isValid = false;
            }
            if (!state.taxId) {
            ...
            if (!state.orderStatus) {
                state.errors.orderStatus = 'Trạng thái đơn không được để trống.';
                isValid = false;
            }
            ...
            create: async (dataSource) => {
                mainGrid.obj = new ej.grids.Grid({
                    ...
                    columns: [
                        ...
                        { field: 'number', headerText: 'Mã đơn hàng', width: 150, minWidth: 150 },
                        { field: 'orderDate', headerText: 'Ngày bán', width: 150, format: 'yyyy-MM-dd' },
                    ...
                    toolbar: [
                        ...
                        { text: 'Sửa', tooltipText: 'Sửa đơn hàng', prefixIcon: 'e-edit', id: 'EditCustom' },
                        { text: 'Xóa', tooltipText: 'Xóa đơn hàng', prefixIcon: 'e-delete', id: 'DeleteCustom' },
                        { type: 'Separator' },
                        { text: 'In hóa đơn PDF', tooltipText: 'Xuất PDF', id: 'PrintPDFCustom' },
                    ],
                    beforeDataBound: () => { },
                    dataBound: function () {
                    ...
                    toolbarClick: async (args) => {
                        ...
                        if (args.item.id === 'AddCustom') {
                            ...
                            state.mainTitle = 'Tạo mới đơn bán hàng';
                            resetFormState();
                            state.secondaryData = [];
            ...
            create: async (dataSource) => {
                secondaryGrid.obj = new ej.grids.Grid({
                    ...
                    columns: [
                        ...
                        {
                            field: 'summary',
                            headerText: 'Mô tả / Ghi chú sản phẩm',
                            width: 200,
                            edit: {
                                create: () => {
