            ...
            handleSubmit: async function () {
                try {
                    ...
                    if (!state.customerGroupId) {
                        state.errors.customerGroupId = 'Nhóm khách hàng không được để trống.';
                        isValid = false;
                    }
                    if (!state.customerCategoryId) {
                        state.errors.customerCategoryId = 'Phân loại khách hàng không được để trống.';
                        isValid = false;
                    }
                    if (!state.street) {
                        state.errors.street = 'Đường / Số nhà không được để trống.';
                        isValid = false;
                    }
                    if (!state.city) {
                        state.errors.city = 'Thành phố / Quận huyện không được để trống.';
                        isValid = false;
                    }
                    if (!state.state) {
                        state.errors.state = 'Tỉnh thành không được để trống.';
                        isValid = false;
                    }
                    if (!state.zipCode) {
                        state.errors.zipCode = 'Mã bưu điện không được để trống.';
                        isValid = false;
                    }
                    if (!state.country) {
                        state.errors.country = 'Quốc gia không được để trống.';
                        isValid = false;
                    }
                    ...
                    if (!state.emailAddress) {
                        state.errors.emailAddress = 'Địa chỉ email không được để trống.';
                        isValid = false;
                    }
                    ...
                    if (response.data.code === 200) {
                        ...
                        if (!state.deleteMode) {
                            state.mainTitle = 'Sửa khách hàng';
                        ...
                        Swal.fire({
                            ...
                            text: response.data.message ?? 'Vui lòng kiểm tra dữ liệu đầu vào.',
            ...
            create: async (dataSource) => {
                mainGrid.obj = new ej.grids.Grid({
                    ...
                    columns: [
                        ...
                        { field: 'number', headerText: 'Mã khách hàng', width: 150, minWidth: 150 },
                        { field: 'name', headerText: 'Tên khách hàng', width: 200, minWidth: 200 },
                        { field: 'customerGroupName', headerText: 'Nhóm', width: 200, minWidth: 200 },
                        { field: 'customerCategoryName', headerText: 'Phân loại', width: 200, minWidth: 200 },
                        { field: 'street', headerText: 'Địa chỉ', width: 200, minWidth: 200 },
                        { field: 'phoneNumber', headerText: 'Số điện thoại', width: 200, minWidth: 200 },
                    ...
                    toolbar: [
                        ...
                        { type: 'Separator' },
                        { text: 'Quản lý Liên hệ', tooltipText: 'Quản lý Liên hệ', id: 'ManageContactCustom' },
                    ],
                    beforeDataBound: () => { },
                    dataBound: function () {
                    ...
                    toolbarClick: async (args) => {
                        ...
                        if (args.item.id === 'AddCustom') {
                            ...
                            state.mainTitle = 'Thêm khách hàng';
                            resetFormState();
                            mainModal.obj.show();
                        }
                        ...
                        if (args.item.id === 'DeleteCustom') {
                            ...
                            if (mainGrid.obj.getSelectedRecords().length) {
                                const selectedRecord = mainGrid.obj.getSelectedRecords()[0];
                                state.mainTitle = 'Xóa khách hàng?';
                                state.id = selectedRecord.id ?? '';
                                mainModal.obj.show();
                            }
                        }
                        ...
                        if (args.item.id === 'ManageContactCustom') {
                            if (mainGrid.obj.getSelectedRecords().length) {
                                const selectedRecord = mainGrid.obj.getSelectedRecords()[0];
                                state.id = selectedRecord.id ?? '';
                                state.manageContactTitle = 'Quản lý Liên hệ';
