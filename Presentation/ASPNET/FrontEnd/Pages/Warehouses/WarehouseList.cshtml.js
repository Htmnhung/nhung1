const App = {
    setup() {
        ...
        const validateForm = function () {
            ...
            if (!state.name) {
                state.errors.name = 'Tên kho hàng không được để trống.';
                isValid = false;
            }
            ...
            create: async (dataSource) => {
                mainGrid.obj = new ej.grids.Grid({
                    ...
                    columns: [
                        ...
                        { field: 'name', headerText: 'Tên kho hàng', width: 200, minWidth: 200 },
                        { field: 'systemWarehouse', headerText: 'Kho hệ thống', width: 200, minWidth: 200, textAlign: 'Center', type: 'boolean', displayAsCheckBox: true },
                        { field: 'description', headerText: 'Mô tả kho', width: 400, minWidth: 400 },
